...
The diagram below shows that the average scores across gender are pretty equal, but the compound score for females varies more than that of men over time. However, this does not prove that women are more moody, but is probably related to the lower number of quotations attributed to women.
